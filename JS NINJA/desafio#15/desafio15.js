(function() {
    ...
    */
    ...
    var johnny = new Person( 'Johnny', 'Ruffino', 22 );
    ...
    */
    console.log( '\nIdade das pessoas:' );
    console.log( `${ johnny.getFullName() } tem ${ johnny.getAge() } anos.` );
    ...
    */
    ...
    console.log( `${ johnny.getFullName() } agora tem ${ johnny.addAge(4).getAge() } anos.` ); //encadeamento de métodos
