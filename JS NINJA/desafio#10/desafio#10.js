(function() {
    ...
    */
    function isOperatorValid( operator ) {
        ...
        /* Usando o retorno do equivalente boleano.
        - Function 'booleanamente' é trufy, e undefined é falsy. 
        Caso não exista a propriedade(ou método) passado o retorno e undefined. pode não ficar tão legivel para outras pessoas mas fica um código menor */

        //return operation[operator] !== undefined; 
        /*Se for undefined a propriedade(ou método) não existe.*/

        //return ( operator === '+' || operator === '-' || operator === '*' || operator === '/' || operator === '%' ); 
        /* Se algum for verdadeiro ele retorna verdadeiro, caso contrário, false. 
        - Código maior e duplicado, caso seja adicionado mais operações teria que mexer nesta parte também. */
    }
    ...
    */
    ...
    - o operador,segun o primeiro número e o do número. O retorno da função
    deve ser a frase:
