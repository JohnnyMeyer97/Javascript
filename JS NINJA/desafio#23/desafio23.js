(function(win, doc) {
   ...
   var $buttonsNumbers = doc.querySelectorAll('[data-js="button-number"]'); //Fez a captura, mas não é um array!
   var $buttonOperations = doc.querySelectorAll('[data-js="button-operation"]');
   var $buttonCE = doc.querySelector('[data-js="button-ce"]');
   var $buttonEqual = doc.querySelector('[data-js="button-equal"]');

    Array.prototype.forEach.call($buttonsNumbers, function(button) { //Transformei em um array
