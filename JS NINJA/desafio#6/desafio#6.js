...
Declare uma variável chamada 'championship' que recebará o nome do campeonato, e imprima o nome desse campeonato no console.
*/
...
Crie uma função chamada 'showTeamPosition' com as seguintes características:
    ...
    "O time que está em [POSIÇÂO]º lugar é o [NOME DO TIME].";
    - Onde [POSIÇÂO] é o valor passado por parâmetro e [NOME DO TIME] é o time que está nessa posição no array criado acima com os nomes dos times.
    ---------------------------------
