...
"A soma de [VALOR 1] e [VALOR 2] é igual a [RESULTADO]."
*/
var value1 = 10;
var value2 = 20;
...
/*
Decrare uma variável chamada 'varShowName' que recebe a função criada acima.
*/
var varShowName = showName;

/*
Usando a variável criada acima, mostre no console o nome e o retorno da função atribuida a ela, com a seguinte frase:
"A função [NOME DA FUNÇÂO] retorna [RETORNO DA FUNÇÂO]."
*/
...
- Essa função deve retornar uma segunda função que fará o seguinte:
    ...
    - Se o operador não for válido, retorne a frase:
    "Operação inválida."
*/
