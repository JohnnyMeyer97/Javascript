(function(window, document) {
    ...
    */
    ...
    // OU utilizando 'curto circuito'
    // verifica primeiro o lado esquerdo, se for falço verifica o direito! ( || = OU, && = E )
    ...
    */
    ...
    // Começe o nome de funções com isNomeFuncao caso essa função retorne true ou false.

    // Começe o nome de funções com hasNomeFuncao caso essa função verifique se existe ou não algo.
