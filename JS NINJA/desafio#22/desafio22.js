(function(win, doc) {
    ...
    */
    function sum() { // Quando o método sum for chamado e passar os argumentos, ele irá iterar por todos os argumentos e somar todos os valores.
    ...
    */
    ...
    //console.log( justNumbers('10anto20,30nio-40') );
