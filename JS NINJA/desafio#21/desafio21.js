(function(win, doc) {
    ...
    */
    ...
    $start.addEventListener('click', startTimer, false); // Passa uma referência à função para que ela seja executada no momento do click.
    $stop.addEventListener('click', stopTimer, false);
    $reset.addEventListener('click', resetTimer, false);

    function startTimer() {
        $timer.value = +$timer.value + 1; // O operador (+) unário converte a string em número.
